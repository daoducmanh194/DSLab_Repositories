...
# I. Processing with dataset
# Load all dataset for getting all words + delete words appear less frequently
def gen_data_and_vocab():
    # only create vocabulary on training file
    ...
    # vocab is only extract from train dataset
    # only choose word which appears more than 10 times, frequency > 10
    vocab = [word for word, freq in zip(word_count.keys(), word_count.values()) if freq > 10]
    vocab.sort()
    with open('/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/vocab-raw.txt', 'w') as f:
        f.write('\n'.join(vocab))
    ...
    with open('/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/20news-train-raw.txt', 'w') as f:
        f.write('\n'.join(train_data))

    with open('/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/20news-test-raw.txt', 'w') as f:
        f.write('\n'.join(test_data))
        ...
        for document in documents:
            ...
            for word in words:
                if word in vocab:
                    ...
                    encoded_text.append(str(unknow_ID))
...
# II. Model: graph + session
# For the main path of session: LSTM contains building computation graph and running session
...
def train_and_evaluate_RNN():
    with open('/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/vocab-raw.txt') as f:
    ...
    with tf.compat.v1.Session() as sess:
        train_data_reader = DataReader(
            data_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/20news-train-encoded.txt',
            batch_size=50,
            vocab_size=vocab_size
        )
        test_data_reader = DataReader(
            data_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/20news-test-encoded.txt',
            batch_size=50,
            vocab_size=vocab_size
        )
        step = 0
...
# gen_data_and_vocab()
# encode_data(data_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/20news-train-raw.txt'
#             , vocab_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/vocab-raw.txt')
# encode_data(data_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/20news-test-raw.txt'
#             , vocab_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/w2v/vocab-raw.txt')

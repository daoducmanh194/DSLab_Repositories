...
def load_dataset():
    train_data_reader = DataReader(
        data_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/20news-bydate/20news-train-tf-idf.txt',
        batch_size=50,
        vocab_size=vocab_size
    )
    test_data_reader = DataReader(
        data_path='/home/genkibaskervillge/Documents/MachineLearning/datasets/20news-bydate/20news-test-tf-idf.txt',
        batch_size=50,
        vocab_size=vocab_size
    )
...
def save_parameters(name, value, epoch):
    ...
    with open('/home/genkibaskervillge/Documents/MachineLearning/datasets/20news-bydate/saved-paras/' + filename, 'w')\
            as f:
        f.write(string_form)
...
def restore_parameters(name, epoch):
    filename = name.replace(':', '-colon-') + '-epoch-{}.txt'.format(epoch)
    with open('/home/genkibaskervillge/Documents/MachineLearning/datasets/20news-bydate/saved-paras/' + filename, 'r')\
            as f:
...
with tf.compat.v1.Session() as sess:
    step, MAX_STEP = 0, 2 * 100 ** 2

    sess.run(tf.compat.v1.global_variables_initializer())
    with open('/home/genkibaskervillge/Documents/MachineLearning/datasets/20news-bydate/results.txt', 'w') as f:
        while step < MAX_STEP:
            ...
            f.writelines(str('Step: {}. Loss: {}\n'.format(step, loss_eval)))

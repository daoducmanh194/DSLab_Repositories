...
class Kmeans:
    ...
    def run(self, seed_value, criterion, threshold):
        ...
        # continually update clusters till convergence
        self._iteration = 0
        while True:
            # reset cluster and retain the centroid
            for cluster in self._clusters:
...
kmeans = Kmeans(20)
kmeans.load_data("/home/genkibaskervillge/Documents/MachineLearning/datasets/20news-bydate/data_tf_idf.txt")
kmeans.run(20, 'max_iters', 10)
print("Purity of Kmeans is: \n", kmeans.compute_purity())
